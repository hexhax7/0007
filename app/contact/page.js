    ...
    <link rel="stylesheet" href="https://fonts.googleapis.com/css2?family=Material+Symbols+Outlined:opsz,wght,FILL,GRAD@24,400,0,0" />
     ...
     <div className={styles.Footer}>
      ...
      <div className={styles.ContactText}>
        ...
        <p>
          We're excited to work with clients who value quality and attention to detail. 
        </p>
        <p> Based in Muswell Hill, and we serve all of London.</p>
        <br></br>
        <h2 className={OpenS.className}> <span className="material-symbols-outlined">call </span> +447547845006 </h2>
        <h2 className={OpenS.className}> <span className="material-symbols-outlined">mail</span> hexhax-drones@outlook.com</h2>
